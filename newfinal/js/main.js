    ...
    try {
        ...
        try {
            ...
            if (employeesResponse.ok) {
                ...
                console.log('Application is in online mode - using Supabase data');
                
                appState.employees = await employeesResponse.json();
                console.log('Loaded employees from Supabase:', appState.employees);
                ...
                if (appState.employees.length > 0) {
                    ...
                    console.log('Loaded advances from Supabase:', appState.advances);
                    ...
                    console.log('Loaded salary reports from Supabase:', appState.salaryReports);
                }
            ...
            throw supabaseError; // Re-throw to trigger localStorage fallback
        }
    } catch (error) {
